...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Number_Version.setText(_translate("MainWindow", "v0.5.0c"))
    ...
    def run(self):
        try:
            ...
            file.write("L" + " " * 15 + str(L) + "\n")
            file.write("nMods" + " " * 11 + str(nMods) + "\n")
            file.write("R0" + " " * 14 + str(R0) + "\n")
            file.write("sigma" + " " * 11 + str(sigma) + "\n")
            file.write("OmegaL2divR2" + " " * 4 + str(OmegaL2divR2) + "\n")
            file.write("z_left" + " " * 10 + str(z_left) + "\n")
            file.write("z_right" + " " * 9 + str(z_right) + "\n")
            file.write("z_start" + " " * 8 + str(z_start) + "\n")
            file.write("z_finish" + " " * 8 + str(z_finish) + "\n")
            file.write("dz" + " " * 14 + str(dz) + "\n")
            file.write("NN" + " " * 14 + str(NN) + "\n")
            file.write("zi" + " " * 11)
            for i in range(0, len(zi), 5):
                for j in range(5):
                    file.write("  " + str(zi[i + j]))
                file.write("\n")
                file.write(" " * 13)
