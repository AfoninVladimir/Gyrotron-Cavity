...
r'''
.. include:: Documentation/MarkdownFiles/GyrotronCavity.md
'''
...
class Ui_MainWindow(object):
    ...
    def run(self):
        ...
        try:
            ...
            list_output = support_functions.transfer_to_the_SI_system(support_functions, list_input)
            ...
            with open("DataForFortran.dat", "w", encoding = "utf-8") as file:
                ...
                file.write(
                    "R0" + " " * 14 + str(support_functions.scientific_notation(support_functions, R0)) + "\n")
                file.write(
                    "sigma" + " " * 11 + str(
                        support_functions.scientific_notation(support_functions, sigma)) + "\n")
                file.write("OmegaL2divR20re" + " " * 1 + str(
                    support_functions.scientific_notation(support_functions, OmegaL2divR2.real)) + "\n")
                file.write("OmegaL2divR20im" + " " * 1 + str(
                    support_functions.scientific_notation(support_functions, OmegaL2divR2.imag)) + "\n")
                file.write(
                    "zleft" + " " * 11 + str(
                        support_functions.scientific_notation(support_functions, z_left)) + "\n")
                file.write(
                    "zright" + " " * 10 + str(
                        support_functions.scientific_notation(support_functions, z_right)) + "\n")
                file.write(
                    "zstart" + " " * 10 + str(
                        support_functions.scientific_notation(support_functions, z_start)) + "\n")
                file.write(
                    "zfin" + " " * 12 + str(
                        support_functions.scientific_notation(support_functions, z_finish)) + "\n")
                file.write(
                    "dz" + " " * 14 + str(support_functions.scientific_notation(support_functions, dz)) + "\n")
                file.write("Tolerance" + " " * 7 + str(
                    support_functions.scientific_notation(support_functions, Tolerance)) + "\n")
                file.write(
                    "Shift" + " " * 11 + str(
                        support_functions.scientific_notation(support_functions, Shift)) + "\n")
                file.write("ShiftFraction" + " " * 3 + str(
                    support_functions.scientific_notation(support_functions, ShiftFraction)) + "\n")
                ...
                file.write("CondThresh" + " " * 6 + str(
                    support_functions.scientific_notation(support_functions, ConductanceThreshold)) + "\n")
                ...
                if len(Ri) % 5 == 0:
                    for i in range(0, len(Ri), 5):
                        for j in range(5):
                            file.write(
                                "  " + str(support_functions.scientific_notation(support_functions, Ri[i + j])))
                        if i < len(Ri) - 5:
                            file.write("\n")
                            file.write(" " * 14)
                else:
            ...
            #     EigenFrequency.append(support_functions.scientific_notation(support_functions, (1 / (2 * pi)) * (
